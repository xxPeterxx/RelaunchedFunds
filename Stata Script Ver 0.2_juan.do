...
****************** Program Settings ******************
global Data 		= "C:\Temp"								// Location to which temporary files are generated
global DataSource  	= "C:\Users\juany\Dropbox\Lippers Tass\Tass_Access_13"		// Location of the original data files (ASCII)
global Gap_days = 60 									// Number of days of the overlapping period (to identify a relaunched fund)
******************************************************
